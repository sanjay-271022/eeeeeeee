...
VEGETA_IMG= "https://cdn.dribbble.com/users/954572/screenshots/5471451/media/e6c8cab6cd70b0fcc77153e31fe040c4.gif"
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("🔐 More Help.", url=f"t.me/unitedtg_bot?start=help"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://cdn.dribbble.com/users/954572/screenshots/5471451/media/e6c8cab6cd70b0fcc77153e31fe040c4.gif",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("🔐 Main Bot", url="https://t.me/friendy_zbott?start=help"),
        InlineKeyboardButton("🔄 Go Inline", switch_inline_query_current_chat=""),
    )
     
    msg = f"""
**[united⚡](https://telegra.ph/GOD-12-18):**
**🤖 MainBot:** `{bot_state}`
**✨ Python:** `3.9`
**🌟 Pyrogram:** `{pyrover}`
**🔷 Platform:** `{sys.platform}`
**💫 Profiles:** [BOT](t.me/friendly_zbot) | [REPO](https://telegra.ph/GOD-12-18)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
