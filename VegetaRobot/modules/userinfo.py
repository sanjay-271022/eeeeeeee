...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "<code>Connecting to telegram api</code>", parse_mode=ParseMode.HTML)

    text = (f"╒═══「<b> Telegram DB Userinfo:</b> 」\n"
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThe Power level of this person is 'tigers of united company'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/tele_united_bots/3558">WHAT IS RANKS</a>]'.format(
            bot.username)
                ...
                [
                  [                  
                       InlineKeyboardButton(
                             text="💭Support",
                             url=f"https://t.me/tele_united_bots"),
                       InlineKeyboardButton(
                             text="📢Updates",
                             url="https://t.me/tele_united_bots")
                     ] 
                ]
            ),
        )
